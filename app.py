...
async def update_uploaded_file(
    ...
    try:
        ...
        new_file_url = s3_handler.upload_to_s3(files, "admin_files")
...
async def delete_uploaded_file(
    ...
    try:
        print(f"[DEBUG] Deleting file_id: {file_id}, by user: {current_user['id']}")
